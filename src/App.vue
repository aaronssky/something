...
export default {
  ...
  data: () => {
    return {
      // tName: "slide-next",
      // routerHistory: global.routerHistory || [],
    };
  },
  created() {
    // global.routerHistory = this.routerHistory;
...
.slide-next {
  ...
  // 进入页过渡中持续存在的class
  &-enter-active {
    transition: all $slideDuration cubic-bezier(1, 0.5, 0.8, 1);
    position: fixed;
    z-index: 1;
    overflow: hidden;
    overflow-y: auto;
